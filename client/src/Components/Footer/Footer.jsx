      ...
      <div className="footer mt-5 py-5">
        <div className="container">
            <div className="row py-4">
                <div className="col-lg-8">
                    <div className="row">
                        <div className="col-md-4">
                            ...
                            <p className="mb-0"><strong>+391 (0)35 2568 2568 4539</strong></p>
                ...
                {/* Fixed: Moved "Good emails" section out of col-lg-8 */}
                <div className="col-lg-4">
                    <h3 className="mb-4">Good emails.</h3>
                    <p className="mb-5">Enter your email bellow to be the first to know about new collections and product launches</p>
                ...
                <div className="row align-items-start">
                    <div className="col-lg-4">
                        <div className="footer-icon-text d-flex gap-3 justify-content-center justify-content-lg-start">
                            <p>@ Glowing 2025 | Powerde by Shopify</p>
                    ...
                    <div className="col-lg-4">
                        <div className="footer-log text-center">
